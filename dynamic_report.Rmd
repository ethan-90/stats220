...
## Plot to look at whether native birds are spotted non-native birds are spotted more often with colours filled as to what the bird type is allowing us to see the proportions that each type of birds were spotted.
...
This chart compares the number of instances native species and non-native species were spotted. The colours filling in the bars represent the species of the bird spotted at that instance.
